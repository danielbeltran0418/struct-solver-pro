    ...
    <div className="space-y-5">
      <Section title={`NODOS  ${model.nodes.length}`}>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-slate-500 text-xs">
                ...
                <th className="text-center pb-1" title="Rótula interna: libera M en todas las barras conectadas">◯Pin</th>
            ...
            <tbody>
              {model.nodes.map((n, i) => (
                <tr key={n.id} className="border-t border-slate-100">
                  ...
                  <td className="text-center"><Chk v={!!n.isPin} onChange={(v) => updateNode(i, { isPin: v })} /></td>
        ...
        <p className="text-[10px] text-slate-400 mt-2">
          ...
          <span className="ml-2">◯Pin = rótula interna (libera M en todas las barras conectadas a ese nodo).</span>
        </p>
